...
for img_info in data['images']:
    ...
    dst_img_path = f"{OUTPUT_DIR}/images/train/{file_name}"
    dst_label_path = f"{OUTPUT_DIR}/labels/train/{file_name.replace('.png', '.txt').replace('.jpg', '.txt')}"
...
print(f"Success! Processed {count} images to '{OUTPUT_DIR}'.")